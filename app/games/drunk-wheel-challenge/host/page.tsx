...
const defaultChallenges = [
  "บอกชื่ออาหารที่คุณอยากกินตอนนี้ 🍔",
  "เล่าเรื่องตลกที่คุณเคยได้ยิน 🎤",
  "อธิบายหนังหรือซีรีส์เรื่องโปรดของคุณ 📺",
  "บอกสถานที่ที่คุณอยากไปเที่ยวมากที่สุด 🌍",
  "เล่าประสบการณ์ที่น่าอายที่สุดของคุณ 😳",
  "ถ้าคุณสามารถมีพลังวิเศษได้หนึ่งอย่าง จะเลือกอะไร? 🦸",
  "อธิบายตัวเองใน 3 คำ 💬",
  "ถ้าเลือกกินอาหารได้แค่อย่างเดียวไปตลอดชีวิต จะเลือกอะไร? 🍛",
  "บอกชื่อเพลงที่ทำให้คุณอารมณ์ดีทุกครั้งที่ฟัง 🎶",
  "ถามผู้เล่นคนอื่นว่าพวกเขาชอบอะไรมากที่สุดในตัวคุณ? 🤔",
];
